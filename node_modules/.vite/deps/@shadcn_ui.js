...
var require_inherits_browser = __commonJS({
  "node_modules/bl/node_modules/inherits/inherits_browser.js"(exports, module) {
...
var Body = class {
  ...
  async formData() {
    ...
    const { toFormData } = await import("./multipart-parser-XG2I6SJZ.js");
...
// node_modules/@shadcn/ui/node_modules/chalk/source/vendor/ansi-styles/index.js
...
// node_modules/@shadcn/ui/node_modules/chalk/source/vendor/supports-color/browser.js
var level2 = (() => {
  if (navigator.userAgentData) {
    const brand = navigator.userAgentData.brands.find(({ brand: brand2 }) => brand2 === "Chromium");
    if (brand && brand.version > 93) {
...
var supportsColor2 = {
  stdout: colorSupport2,
  stderr: colorSupport2
};
var browser_default3 = supportsColor2;

// node_modules/@shadcn/ui/node_modules/chalk/source/utilities.js
...
// node_modules/@shadcn/ui/node_modules/chalk/source/index.js
var { stdout: stdoutColor2, stderr: stderrColor2 } = browser_default3;
...
var getModelAnsi2 = (model, level3, type, ...arguments_) => {
  if (model === "rgb") {
    if (level3 === "ansi16m") {
  ...
  if (model === "hex") {
    return getModelAnsi2("rgb", level3, type, ...ansi_styles_default2.hexToRgb(...arguments_));
  }
...
for (const model of usedModels2) {
  styles4[model] = {
    get() {
      const { level: level3 } = this;
      return function(...arguments_) {
        const styler = createStyler2(getModelAnsi2(model, levelMapping2[level3], "color", ...arguments_), ansi_styles_default2.color.close, this[STYLER2]);
  ...
  styles4[bgModel] = {
    get() {
      const { level: level3 } = this;
      return function(...arguments_) {
        const styler = createStyler2(getModelAnsi2(model, levelMapping2[level3], "bgColor", ...arguments_), ansi_styles_default2.bgColor.close, this[STYLER2]);
        return createBuilder2(this, styler, this[IS_EMPTY2]);
      };
    }
  };
...
var logger = {
  error(...args) {
    console.log(source_default2.red(...args));
  },
  warn(...args) {
    console.log(source_default2.yellow(...args));
  },
  info(...args) {
    console.log(source_default2.cyan(...args));
  },
  success(...args) {
    console.log(source_default2.green(...args));
  }
};
